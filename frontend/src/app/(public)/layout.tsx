  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <Link href="/" className="flex items-center space-x-2 space-x-reverse flex-shrink-0">
            <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-600 rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-sm sm:text-lg">م</span>
            </div>
            <span className="text-lg sm:text-xl font-bold text-gray-900 hidden xs:block">متجري</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-3 lg:space-x-4 space-x-reverse">
            ...
            {/* Wishlist */}
            <Link href="/wishlist" className="p-2 text-gray-700 hover:text-red-600 transition-colors relative" title="المفضلة">
              <svg className="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Shopping Cart */}
            <Link href="/cart" className="p-2 text-gray-700 hover:text-blue-600 transition-colors relative" title="السلة">
              <svg className="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/login" className="bg-blue-600 text-white px-3 py-1.5 lg:px-4 lg:py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm lg:text-base font-medium">
              دخول
            </Link>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden lg:hidden py-4 border-t border-gray-200 bg-white">
            <nav className="flex flex-col space-y-1">
              <Link
                href="/"
                className="flex items-center py-3 px-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
              ...
              >
                ...
                المفضلة
                <span className="mr-auto bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">2</span>
              </Link>
              <Link
                href="/about"
                className="flex items-center py-3 px-2 text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
              ...
              <div className="pt-4 mt-4 border-t border-gray-200">
                <Link
                  href="/login"
                  className="flex items-center py-3 px-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors font-medium"
                  onClick={() => setIsMenuOpen(false)}
                >
                  <svg className="w-5 h-5 ml-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="block md:hidden space-y-4">
          ...
          <div className="pb-6 border-b border-gray-800">
            ...
            <div className="flex space-x-4 space-x-reverse">
              <button className="text-gray-400 hover:text-white transition-colors p-2 bg-gray-800 rounded-lg">
          ...
          <div className="border-b border-gray-800 pb-4">
            ...
            >
              ...
              <svg
                className={`w-5 h-5 transition-transform ${openSections.quickLinks ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            {openSections.quickLinks && (
              <ul className="space-y-3 mt-3">
                <li><Link href="/about" className="text-gray-400 hover:text-white transition-colors block py-1">من نحن</Link></li>
                <li><Link href="/contact" className="text-gray-400 hover:text-white transition-colors block py-1">اتصل بنا</Link></li>
                <li><Link href="/privacy" className="text-gray-400 hover:text-white transition-colors block py-1">سياسة الخصوصية</Link></li>
                <li><Link href="/terms" className="text-gray-400 hover:text-white transition-colors block py-1">الشروط والأحكام</Link></li>
              </ul>
            )}
          </div>
          ...
          <div className="border-b border-gray-800 pb-4">
            ...
            >
              ...
              <svg
                className={`w-5 h-5 transition-transform ${openSections.customerService ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            {openSections.customerService && (
              <ul className="space-y-3 mt-3">
                <li><Link href="/help" className="text-gray-400 hover:text-white transition-colors block py-1">مركز المساعدة</Link></li>
                <li><Link href="/returns" className="text-gray-400 hover:text-white transition-colors block py-1">الإرجاع والاستبدال</Link></li>
                <li><Link href="/shipping" className="text-gray-400 hover:text-white transition-colors block py-1">الشحن والتوصيل</Link></li>
                <li><Link href="/faq" className="text-gray-400 hover:text-white transition-colors block py-1">الأسئلة الشائعة</Link></li>
              </ul>
            )}
          </div>
          ...
          <div>
            ...
            >
              ...
              <svg
                className={`w-5 h-5 transition-transform ${openSections.contactInfo ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
            ...
            {openSections.contactInfo && (
              <div className="space-y-3 mt-3 text-gray-400">
                <p className="flex items-center space-x-2 space-x-reverse py-1">
                ...
                <p className="flex items-start space-x-2 space-x-reverse py-1">
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              ...
              <p className="flex items-start space-x-2 space-x-reverse">
                <svg className="w-4 h-4 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
