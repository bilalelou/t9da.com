...
<input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full rounded-lg border-gray-300 py-2.5 pr-10 pl-3 shadow-sm" placeholder="your@email.com (اختياري)" />
                                </div>
